...
def main():
    ...
    if TEST_MODE:
        ...
        if DATASET_TYPE == 'mnist':
            ...
            a0 = {0: 0.01, 500: 0.01, 1000: 0.01, 2000: 0.01, 4000: 0.01,
                  8000: 0.01, 16000: 0.01, 32000: 0.01, 64000: 0.01}

        elif DATASET_TYPE in ('svhn'):
            beta_values = [500, 1000, 2000, 4000, 8000, 16000, 32000, 64000]
            a0 = {0: 0.005, 500: 0.005, 1000: 0.005, 2000: 0.005, 4000: 0.005,
                  8000: 0.005, 16000: 0.005, 32000: 0.005, 64000: 0.005}
            ...
            a0 = {0: 0.5, 3: 36.0, 6: 18.0, 12: 9.0, 25: 4.5,
                  50: 2.25, 100: 1.2, 200: 0.6, 400: 0.3}
